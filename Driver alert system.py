...
background_image = Image.open(r"C:\Users\ACER\OneDrive\Desktop\Afra\driver_monitoring_system\project\Interface.png")
...
start_button = tk.Button(root, text="START DETECTION", font=("Times New Roman", 12), fg="black", bg="white",
                         command=run_detection_thread)
start_button_window = canvas.create_window(380, 170, anchor="center", window=start_button)

stop_button = tk.Button(root, text="STOP DETECTION", font=("Times New Roman", 12), fg="black", bg="white",
